...
public class game2x6 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game2x6);

        GridLayout gridLayout = (GridLayout) findViewById(R.id.Game2x6);
